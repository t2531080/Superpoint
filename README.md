...
# Result
__Note that the results of superpoint(rpautrat) are copied from [here](https://github.com/rpautrat/SuperPoint/tree/master). In order to save time our model is trained on coco 2017 test set__
